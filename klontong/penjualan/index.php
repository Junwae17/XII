...
include '../koneksi.php';
$barang = mysqli_query($koneksi, "SELECT * FROM penjualan");
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="entry.php" class="btn btn-md btn-link" style="margin-bottom: 10px">Entry Penjualan</a>
                        ...
                        <table class="table table-bordered" id="myTable">
                            ...
                            foreach ($data as $row) {
                                ...
                                echo "<td>" . $tgl = $row['tgl_transaksi'] . "</td>";
                                echo "<td>" . $id_struk = $row['id_struk'] . "</td>";
                                ?>
                                <td>
                                    <a href="proses-hapus.php?id_brg=<?php echo $row['id_jual'] ?>"
                                        class="btn btn-sm btn-danger" onclick="return confirm ('yakin hapus?')">HAPUS</a>
                                    <a href="detail.php?id_brg=<?php echo $row['id_jual'] ?>"
