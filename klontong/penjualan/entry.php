<html>
    ...
    <br>
        ...
        foreach ($barang as $row){
            echo "<tr>";
            echo "<td>". $i++ ."</td>";
            echo "<td>".$id_brg = $row['id_brg']."</td>";
            echo "<td>".$nama_barang = $row['nm_brg']."</td>";
            echo "<td>Rp.". number_format($harga_jual = $row['hrg_jual'])."-.</td>";
            ?>
            <td>  
                <a href="tambah.php?id_brg=<?php echo $row['id_brg'] ?>" class="btn btn-sm btn-primary">TAMBAH</a>  
            </td>
            <?php 
            echo "</tr>";
        }
